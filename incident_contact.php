...
/**
 *  \file       incident_contact.php
 *  \ingroup    incident
 *  \brief      Tab for contacts linked to Incident
 */
...
$title = $langs->trans("Incident")." - ".$langs->trans('ContactsAddresses');
//$title = $object->ref." - ".$langs->trans('ContactsAddresses');
$help_url = '';
//$help_url='EN:Module_Third_Parties|FR:Module_Tiers|ES:Empresas';
llxHeader('', $title, $help_url, '', 0, 0, '', '', '', 'mod-incident page-card_contact');
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("Incident"), -1, $object->picto);

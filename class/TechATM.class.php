...
class TechATM
{
    ...
    /**
     * @var \incident\DoliDb        Database handler (result of a new DoliDB)
     */
    public $db;
    ...
    /**
     * @var \incident\reponse_code  a http_response_header parsed reponse code
     */
    public $reponse_code;

    /**
     * @var \incident\http_response_header  the last call $http_response_header
     */

    public $http_response_header;

    /**
     * @var \incident\TResponseHeader  the last call $http_response_header parsed <- for most common usage (see self::parseHeaders() function)
     */
    ...
    /**
     * @param \incident\DolibarrModules $moduleDescriptor
     */

...
/**
 *  \file       incident_note.php
 *  \ingroup    incident
 *  \brief      Tab for notes on Incident
 */
...
if ($id > 0 || !empty($ref)) {
	$upload_dir = $conf->incident->multidir_output[empty($object->entity) ? $conf->entity : $object->entity]."/".$object->id;
}
...
$title = $langs->trans('Incident').' - '.$langs->trans("Notes");
//$title = $object->ref." - ".$langs->trans("Notes");
$help_url = '';
//$help_url='EN:Customers_Orders|FR:Commandes_Clients|ES:Pedidos de clientes';

llxHeader('', $title, $help_url, '', 0, 0, '', '', '', 'mod-incident page-card_notes');
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("Incident"), -1, $object->picto);
